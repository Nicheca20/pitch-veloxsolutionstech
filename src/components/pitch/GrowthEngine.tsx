...
const LANES = [
  { label: "Industria A", delay: 0 },
  { label: "Industria B", delay: 0.12 },
  { label: "Industria C", delay: 0.24 },
] as const;
  ...
  return (
    <div ref={ref} className="relative mx-auto w-full max-w-5xl">
            ...
            {STATIONS.map((s, i) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="mt-5 text-[0.95rem] font-semibold tracking-tight text-foreground md:text-base">
                    {s.title}
                  </div>
                  <div className="mt-1 text-xs leading-snug text-muted-foreground">{s.tag}</div>
                </div>
              );
            })}
          </div>
      ...
      <div className="relative mt-16">
        <div className="mb-6 text-center text-[0.68rem] uppercase tracking-[0.32em] text-muted-foreground">
          Capa base replicable
        </div>
        ...
        >
            ...
            {LANES.map((l, i) => {
              ...
              return (
                <div key={l.label} className="flex items-center gap-4">
                  <div className="w-24 shrink-0 text-[0.7rem] uppercase tracking-[0.16em] text-muted-foreground md:w-28">
                    {l.label}
                  </div>
                  ...
                  <div
                    className="w-20 shrink-0 text-right text-[0.7rem] font-semibold text-ice transition-opacity duration-500 md:w-24"
          ...
          <p className="mt-6 border-t border-white/10 pt-5 text-center text-sm leading-relaxed text-muted-foreground md:text-[0.95rem]">
